...
Каждая команда заканчивается каким-либо результатом, в терминах скрипта - статусом. Ниже приведена таблица со всеми
возможными статусами с уточнением в каких именно командах конкретный статус может возникать:

| Статус | Описание значения | Может возникнуть в командах |
| ------ | ----------------- | --------------------------- |
...
| CREATED/NO PINGING | Виртуальная машина создана, но не доступна по сети | create |
| CREATED/PINGING | Виртуальная машина создана и доступна по сети | create |
| DESTROYED | Виртуальная машина уничтожена | create (с опцией `-d`), destroy |
| REBOOTED | Виртуальная машины перезагружена (без проверки на доступность по сети) | create (с опцией `-d`) |
| REBOOTED/NO PINGING | Виртуальная машина перезагружена, но не доступна по сети | reboot |
| REBOOTED/PINGING | Виртуальная машина перезагружена и доступна по сети | reboot |
| RECREATED/NO PINGING | Виртуальная машина пересоздана, но не доступна по сети | create (с опцией `-f`) |
| RECREATED/PINGING | Виртуальная машина пересоздана и доступна по сети | create (с опцией `-f`) |
| STARTED/PINGING | Виртуальная машина включена и доступна по сети | start |
| STARTED/NO PINGING | Виртуальная машина включена, но не доступна по сети | start |
