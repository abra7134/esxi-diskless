...
и отсутствии конфигурации для этой виртуальной машины в конфигурационном файле хук-скрипты запускаться не будут,
т.к. скрипту неизвестно какие именно хук-скрипты нужно запускать.
