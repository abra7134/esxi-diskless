...
v3.??????
- Исправлено ошибка в определении статуса питания виртуальной машины, из-за которой виртуальная
  мащина считалась выключенной или уничтоженной даже если все 10 попыток ожидания говорили
  об обратном (появилась в v2.210409)
- Исправлен вывод статуса (`SKIPPED ISO` вместо `ABORTED`) для ISO-образов, у которых был
