...
- Теперь при создании виртуальной машины её существование проверяется на всех гипервизорах, а не только
  на котором она будем создаваться (с помощью дополнительного ключа можно вернуть и прежнее поведение)
- Добавлена возможность проверки существования виртуальной машины на всех гипервизорах при её создании
