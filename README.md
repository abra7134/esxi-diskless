...
* Сборка `ISO`-образов (шаблонов) с использованием базового слоя выбранной операционной системы;
...
* Создание виртуальных машин с возможностью удаления одноименной на другом гипервизоре (миграция)
